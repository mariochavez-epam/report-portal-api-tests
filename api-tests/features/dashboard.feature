Feature: Dashboard Tests
  ...
  @test-009
  Scenario: User is not able to create a dashboard within POST request without name field
    Given I have random data to create a dashboard
  ...
  @test-010
  Scenario: User is not able to create a dashboard within POST request that already exist
  ...
  @test-007
  Scenario: User get proper error message when getting a dashboard that do not exist
  ...
  @test-011
  Scenario: User is not able to remove a dashboard that do not exist within DELETE request
    Given I request a not existing dashboard
